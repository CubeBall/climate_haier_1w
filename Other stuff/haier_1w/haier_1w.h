...
class Haier1w : public climate::Climate, public PollingComponent, public remote_base::RemoteReceiverListener {
 public:
  Haier1w(float minimum_temperature=16.0f, float maximum_temperature=31.0f, float temperature_step = 1.0f,
  ...
  void set_bit_space(uint32_t bit_space) { this->bit_space_ = bit_space; }
  void set_bit_one(uint32_t bit_one) { this->bit_one_ = bit_one; }
  void set_bit_zero(uint32_t bit_zero) { this->bit_zero_ = bit_zero; }
